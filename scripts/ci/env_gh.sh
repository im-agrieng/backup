...
if [[ "${CI_TAG}" ]]; then
	...
	export IOS_APP_IDENTIFIER="com.imagrieng.sigpacgo"  # Updated from ch.opengis.qfield
	export IOS_PROVISIONING_PROFILE_SPECIFIER="match AppStore com.imagrieng.sigpacgo"  # Updated
	...
	export IOS_APP_IDENTIFIER="com.imagrieng.sigpacgo-dev"  # Updated
	export IOS_PROVISIONING_PROFILE_SPECIFIER="match Development com.imagrieng.sigpacgo-dev"  # Updated
